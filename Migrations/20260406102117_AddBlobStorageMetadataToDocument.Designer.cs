...
namespace RagAgentApi.Migrations
{
    ...
    [Migration("20260406102117_AddBlobStorageMetadataToDocument")]
    partial class AddBlobStorageMetadataToDocument
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RagAgentApi.Models.ErrorLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RagAgentApi.Models.PostgreSQL.DemoExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DemoType", "CreatedAt")
                        .HasDatabaseName("IX_DemoExecutions_DemoType_CreatedAt");

                    b.ToTable("DemoExecutions");
                });

            modelBuilder.Entity("RagAgentApi.Models.PostgreSQL.DemoTestData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
